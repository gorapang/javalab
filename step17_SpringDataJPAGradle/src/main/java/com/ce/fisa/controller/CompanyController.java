...
public class CompanyController {
	...
	@GetMapping("emp2")
	public Emp2DTO getEmpEname(@RequestParam("ename") String ename) throws NotExistEmp2Exception {
	...
	//http://ip:port/step17/emp2
	//? empno=사번&newDeptno=이동부서번호
	@PostMapping("emp2")
	public String updateEmpBydeptno(@RequestParam("empno") int empno, @RequestParam("newDeptno") int newDeptno) throws NotExistEmp2Exception  {
